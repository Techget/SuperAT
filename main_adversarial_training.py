...
# load pretrained VAE
gen=VAE(input_height=64).from_pretrained('cifar10-resnet18')
gen=gen.to(device)
...
for epoch in range(epochs):
    for i, (data, targets) in enumerate(data_loader, 0):
        ...
        # train vae
        x_reconstructed, mean, logvar = gen.run_step(datav)
    ...
    utils.save_checkpoint(gen, checkpoint_dir+'vae/checkpoints', epoch)
    utils.save_checkpoint(discrim, checkpoint_dir+'discriminator/checkpoints', epoch)
